...
if __name__ == '__main__':
    fer = FERPlus('/home/FaceData/FERPlus/data-aligned/', 'train',transform=transforms.ToTensor())
    # pdb.set_trace()
    fer_test = FERPlus('/home/FaceData/FERPlus/data-aligned/', 'test', mode='probability')

    print(fer.__len__())
    print(fer_test.__len__())
    
    trainloader = torch.utils.data.DataLoader(fer,batch_size=64,drop_last=False)
